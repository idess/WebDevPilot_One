package com.kglory.web.util.security;

import java.io.UnsupportedEncodingException;

import org.apache.commons.codec.binary.Base64;

import com.kglory.web.util.security.seed.AnsiX923Padding;
import com.kglory.web.util.security.seed.SeedCipher;
...
public class SeedCrypto {
	...
	public String decrypt(String strVal) {
		try {
			SeedCipher seed = new SeedCipher();
			String decryptText = seed.decryptAsString(Base64.decodeBase64(strVal), pbUserKey,
					"UTF-8");
			return decryptText;
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
